...
We have all seen trees; they have branches, and those branches have sub-branches. That's right, this sounds a lot like recursion. 
...
The code above leaves you with a symmetrical, socially-anxious looking tree. We don't want that, now do we? 

We can make new turtles, add leaves, color, and soul. I randomised a lot of the process, so that it'd look more natural. I made it so that each leave is drawn with a fifty-fifty chance, and that the angle in which our turtle tilts is chosen randomly for each individual tree. With a few more adjustments, and a lot of dirty (filthy would be more accurate) coding, I got to this :
